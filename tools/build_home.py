...
H = [
 dict(slug="gunaydin", name="Günaydın", logo=LOGO['gunaydin'], cls="",
      ...
      facts=[("Cuisine","Turkish steakhouse"),("Address","Place Vendôme, Lusail"),("Status","Open")], caps=("The cut","The room")),
 ...
 dict(slug="al-beiruti", name="Al Beiruti", logo=LOGO['al-beiruti'], cls="",
      video="videos/al-beiruti.mp4", poster="images/brands/al-beiruti-poster.jpg", still="images/brands/al-beiruti-room.jpg",
