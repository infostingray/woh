...
HOUSES = [
 dict(slug="gunaydin", name="Günaydın", short="Günaydın",
      ...
      video="videos/gunaydin.mp4", poster="images/brands/gunaydin-hero.jpg",
 ...
 dict(slug="kumar", name="Kumar", short="Kumar",
      ...
      video="videos/kumar.mp4", poster="images/brands/kumar-3.jpg",
      gallery=[("images/brands/kumar-4.jpg","The thali"),("images/brands/kumar-6.jpg","The skewer"),("images/brands/kumar-5.jpg","The tikka")],
 ...
 dict(slug="eleven-green", name="Eleven Green", short="Eleven Green",
      ...
      gallery=[("images/brands/eleven-green-5.jpg","The soft serve"),("images/brands/eleven-green-6.jpg","The counter"),("images/brands/eleven-green-3.jpg","The trays")],
      links=[],
