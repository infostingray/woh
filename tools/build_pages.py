...
<section class="tenets overfilm" id="approach">
  ...
  <div class="tenets__list">
    <div class="tenet" data-reveal>
      <h3>Origin first.</h3>
      <p>Original recipe. Original room. Adapted for Doha, never diluted. If a dish or a detail matters at home, it matters here.</p>
    </div>
    <div class="tenet" data-reveal>
      <h3>Senior people, every shift.</h3>
      <p>The people accountable for the result are the people in the building. Not a head office, not a dashboard. A name on the floor.</p>
    </div>
    <div class="tenet" data-reveal>
      <h3>Built to last.</h3>
      <p>Group infrastructure, independent attention. Finance, licensing and supply run centrally. Service, kitchen and character stay the house's own.</p>
    </div>
  </div>
</section>
